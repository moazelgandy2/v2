...
export const codeLines = [
  ...
  { type: "property", content: "  theme: {", color: "text-sky-300" },
  {
    type: "value",
    content: "    primary: '#08A88A'",
    color: "text-orange-300",
  },
  { type: "property", content: "  },", color: "text-sky-300" },
  {
    type: "property",
  ...
  { type: "function", content: "app.initialize();", color: "text-yellow-300" },
  { type: "function", content: "app.launch();", color: "text-yellow-300" },
];
